...
function constructor (id) {
	...
	{// @endlock
		if(this.getValue()) {
			$comp.sources.father.getAttribute('homeStreet1').setValue(sources.family.mainStreet1);
			$comp.sources.father.getAttribute('homeStreet2').setValue(sources.family.mainStreet2);
			$comp.sources.father.getAttribute('homeCity').setValue(sources.family.mainCity);
			$comp.sources.father.getAttribute('homeState').setValue(sources.family.mainState);
			$comp.sources.father.getAttribute('homeZipCode').setValue(sources.family.mainZipCode);
		}
	};// @lock
