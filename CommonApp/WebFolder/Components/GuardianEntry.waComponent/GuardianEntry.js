...
function constructor (id) {
	...
	var textFieldGuardianRelationship = {};	// @textField
	...
	textFieldGuardianRelationship.change = function textFieldGuardianRelationship_change (event)// @startlock
	{// @endlock
	...
	{// @endlock
		if(this.getValue()) {
			guardian.homeAddress1 = homeAddress1;
			guardian.homeAddress2 = homeAddress2;
			guardian.homeCity = homeCity;
			guardian.homeZipCode = homeZipCode;
		}
		else {
			guardian.homeAddress1 = '';
			guardian.homeAddress2 = '';
			guardian.homeCity = '';
			guardian.homeZipCode = '';
		}
		source.guardian.autoDispatch();
	};// @lock
	...
	WAF.addListener(this.id + "_textFieldGuardianRelationship", "change", textFieldGuardianRelationship.change, "WAF");
